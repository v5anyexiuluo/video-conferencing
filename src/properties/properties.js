export default {
	sideNavs: [
        {id:'1', name: 'meeting', title: '视频会议', icon:'el-icon-view', image: '', badge: false, component: '', subs:[{id: '1-1', name: 'now', title: '马上开会', icon:'', image:'', component:'MeetingNow'},{id: '1-2', name: 'order', title: '预约会议', icon:'', image:'', component:'MeetingOrder'},{id: '1-3', name: 'history', title: '历史会议', icon:'', image:'', component:'MeetingHistory'},{id: '1-4', name: 'current', title: '当前会议', icon:'', image:'', component:'MeetingCurrent'}]},
        ...
        {id:'5', name: 'settings', title: '设置', icon:'el-icon-setting', image: '', badge: false, component: ''}
	],
}