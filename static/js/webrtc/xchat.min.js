function XChatKit(o) {
    ...
    document.title = l, navigator.mediaDevices.enumerateDevices().then(function (e) {
        ...
        function n(e, t) {
            ...
            c = 1, u = e.chatroom, e.msgtype = "RequestJoinConference", I(e), xchatkit.StartRecording(e.fromuser)
        }, this.LeaveConference = function (e) {
            for (var n in e.msgtype = "RequestLeaveConference", xchatkit.SendJSON(e), E) E[n] && E[n].close();
            ...
            if (n) {
                var o = y[e],
                    t = (new Date).getTime(),
                    r = u + "-" + o + "-" + t + "-" + e + ".webm";
                h[e].setFileName(r), n.stopRecording(function (e) {
                    this.save()
                }), delete y[e], delete h[e]
            }
